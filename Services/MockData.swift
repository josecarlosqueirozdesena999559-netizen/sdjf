...
struct MockData {
    ...
    static let products: [Product] = [
        Product(id: UUID(), title: "iPhone 13 128GB", description: "Excelente estado, sem marcas de uso. Bateria 90%.", price: 2499.00, condition: .used, categoryId: categories[1].id, sellerId: users[3].id, location: "Fortaleza - CE", images: [], createdAt: Date(), views: 150, isActive: true, deliveryMethod: "Retirada em mãos", acceptsNegotiation: true),
        ...
        Product(id: UUID(), title: "Bicicleta Caloi Aro 29", description: "Bicicleta mountain bike, excelente para trilhas.", price: 950.00, condition: .used, categoryId: categories[5].id, sellerId: users[2].id, location: "Belo Horizonte - MG", images: [], createdAt: Date(), views: 45, isActive: true, deliveryMethod: "Retirada em mãos", acceptsNegotiation: true),
        Product(id: UUID(), title: "PlayStation 5", description: "Console PS5 versão disco. Acompanha 1 controle e 2 jogos.", price: 3800.00, condition: .used, categoryId: categories[7].id, sellerId: users[4].id, location: "Curitiba - PR", images: [], createdAt: Date(), views: 500, isActive: true, deliveryMethod: "A combinar", acceptsNegotiation: false)
    ]
}
